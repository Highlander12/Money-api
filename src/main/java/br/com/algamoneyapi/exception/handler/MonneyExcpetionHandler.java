package br.com.algamoneyapi.exception.handler;
...
@Controller
@ControllerAdvice
public class MonneyExcpetionHandler extends ResponseEntityExceptionHandler {
	...
	//Tratativa de Erro Criação de Itens
	@Override
